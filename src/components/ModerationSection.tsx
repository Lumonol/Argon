      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 md:gap-6 mb-8 md:mb-14">
          ...
          <ScrollReveal direction="right" delay={100}>
            <p className="text-muted-foreground text-base md:text-lg max-w-md leading-relaxed">
              Ban, warn, and monitor players remotely — with every action logged and fully accountable.
            </p>
          </ScrollReveal>
        </div>
        ...
        <ScrollReveal direction="up" delay={150}>
          <div className="max-w-4xl mx-auto rounded-2xl overflow-hidden border border-border/30 bg-card/50 mb-8 md:mb-12">
            <img
              src={showcaseModeration}
              alt="In-game moderation overview"
        ...
        <ScrollReveal direction="up" delay={200}>
          <div className="text-center">
            <Link to="/features/moderation" className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-primary transition-colors">
