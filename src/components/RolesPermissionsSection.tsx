      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 md:gap-6 mb-8 md:mb-14">
          ...
          <ScrollReveal direction="right" delay={100}>
            <p className="text-muted-foreground text-base md:text-lg max-w-md leading-relaxed">
              Fine-grained access control with role hierarchies, permission toggles, and workspace configuration.
            </p>
          </ScrollReveal>
        </div>
        ...
        <ScrollReveal direction="up" delay={200}>
          <div className="text-center">
            <Link to="/features/roles-permissions" className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-primary transition-colors">
