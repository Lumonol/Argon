      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 md:gap-6 mb-8 md:mb-14">
          ...
          <ScrollReveal direction="right" delay={100}>
            <p className="text-muted-foreground text-base md:text-lg max-w-md leading-relaxed">
              A complete staff directory with profiles, departments, and real-time online tracking.
            </p>
          </ScrollReveal>
        </div>
        ...
        <ScrollReveal direction="up" delay={200}>
          <div className="text-center">
            <Link to="/features/staff-management" className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-primary transition-colors">
